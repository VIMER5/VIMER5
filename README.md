...
🚀 Текущий проект: Платформа для общения с реактивным интерфейсом и мгновенным обменом сообщениями.

💻 Frontend: Глубокая работа с экосистемой Vue 3 (Composition API).

⚙️ Backend: Node.js, Express, архитектура API и работа с данными в реальном времени.
